...
This integration provides sensors, binary sensors, switches, and services to monitor and control your Kubernetes cluster directly from Home Assistant. For the full feature list, see the [README features section](https://github.com/tibuntu/homeassistant-kubernetes#readme).

## Getting Started

For installation instructions, please refer to the main [README](https://github.com/tibuntu/homeassistant-kubernetes#readme) in the project repository, then follow the [Configuration Guide](CONFIGURATION.md) and [Service Account Setup](SETUP.md) for detailed setup instructions.
